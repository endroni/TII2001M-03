<?php
    class cadastroPaciente{
        ...
        /*public function __construct(){
            try {
                $this->_con = new PDO('mysql:host=localhost;dbname=clinica','root','');
        ...
        public function getPaciente(){
            ...
            if(isset($_POST['nome'])){
                ...
                $sql = $pdo->prepare("INSERT INTO tbl_registroPaciente (nome, rua, logradouro, complemento, bairro, CEP, email, tl_fixo, cel, tl_sec) VALUES (:nome,:rua,:logr,:comp,:bai,:CEP,:email,:tl_fixo,:cel,:tl_sec)");
